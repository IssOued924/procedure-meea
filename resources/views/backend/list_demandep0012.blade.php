...
@php
    $userRole = Auth::user()->role->libelle; // Obtenez le libellé du rôle de l'utilisateur
@endphp

<!-- Boutons d'action en fonction de l'état et du rôle -->
@if (($demande->etat == 'D' && in_array($userRole, ['Reception', 'Etudes', 'Gestionnaire', 'administration'])) ||
...
@if (($demande->etat != 'A' && $demande->etat != 'S') && in_array($userRole, ['Reception', 'Etudes', 'Gestionnaire', 'administration']))
