                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 offset-md-3">
                                        ...
                                        <select name="procedure" id="procedure" class="form-select border-success"
                                            onchange="loadDemandeListe()">
                                            <option class="mb-3" value=""></option>
                                            @foreach ($procedures as $proc)
                                                <option class="mb-3"
                                                    {{ $selectedProcedure == $proc->libelle_court ? 'selected' : '' }}
                                                    value="{{ $proc->libelle_court }}">{{ $proc->libelle_long }}</option>
                                            @endforeach
                                        </select><br><br>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($demande->etat == 'S' && !is_null($demande->output_file))
                                                        <a class="btn btn-success text-white"
                                                            href="{{ Storage::url($demande->output_file) }}"
                                                            target="_blank"><b><i class=" bi bi-download"></i>
                                                                Télécharger</b></a>
                                                    @endif
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <a class="text-success" target="_blank"
                                                                            href="{{ Storage::url($demande->note_etude_file) }}">
                                                                            Note D'étude</a>
                                                                    </div>
                                                                </div>
                                                                <br>
