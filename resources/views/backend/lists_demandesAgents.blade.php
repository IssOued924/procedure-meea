                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                                            ...
                                            <?php if (!is_null($demandes)) { ?>
                                                ...
                                                <tr class="table-bordered">
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($demande->etat =='R')
                                                        <button title="Modifier" type="button" class="btn btn-info " data-bs-toggle="modal" data-bs-target="#ModifModal{{ $demande->uuid }}"> <i class="bi bi-pencil-square text-white">Modifier </i> </button>
                                                        @endif
                            ...
                            <!-- Modal Modifier -->
                            <div class="modal" id="ModifModal{{ $demande->uuid }}">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="demande timbre" class="fw-bold">Document de l'arme<span style="color:red">
                                                            *</span></label>
                                                    <input type="file" name="list_personne" class="form-control border-success" required>
                                                </div>
                                                <div class="col-6">
                                                    <label for="demande timbre" class="fw-bold">Permis de port d'arme<span style="color:red">
                                                            *</span></label>
                                                    <input type="file" name="list_personne" class="form-control border-success" required>
                                                </div>
                                            </div>
