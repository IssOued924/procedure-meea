                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="Voir Détail" href="{{ route('detail-demande', ['process' => 'P002', 'id_demande' => $demande->uuid]) }}" class="btn btn-primary ">
...
<script>
    function loadDemandeListeByStatus() {
        let url = '/dossiers-by-status?procedure=P002&etat=' + $('#etat').val();
        window.location = url;
    }
</script>
