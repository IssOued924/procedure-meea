                                ...
                                <tbody>
                                    ...
                                    <tr class="table-bordered">
                                        ...
                                        <td>
                                            ...
                                            <a title="Voir Détail" href="{{ route('detail-demande', ['process' => 'P006', 'id_demande' => $demande->uuid]) }}" class="btn btn-primary ">
                                                ...
                                                <div class="modal fade" id="assigner{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content bgcustom-gradient-light">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post" enctype="multipart/form-data" action="{{ route('assignation', ['model' =>'AffectationP006', 'idDemande' => $demande->uuid ,'nameDemandeId'=> 'demande_p006_id', 'tableName'=>'demande_p006_s'] ) }}">
                                                                    @csrf
...
<script>
    function loadDemandeListeByStatus() {
        let url = '/dossiers-by-status?procedure=P006&etat=' + $('#etat').val();
        window.location = url;
    }
</script>
@endsection
