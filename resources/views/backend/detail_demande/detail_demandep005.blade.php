                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp005-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold"> <strong>Nom & Prenom</strong> </label>
                                        <span class="border-success form-control">{{ $demande->usager->nom.'
                                                    '.$demande->usager->prenom}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold"> <strong>Téléphone</strong> </label>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                    <label class="siege_social fw-bold">Province de résidence</label>
                                                <span class="border-success form-control">{{ $demande->province->libelle}}</span>                                        
                                    </div>

                                    <div class="col-6">
                                    <label class="siege_social fw-bold">Commune de résidence/siège</label>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Nature du produit</label>
                                        <span class="border-success form-control">{{ $demande->nature_produit ? $demande->nature_produit : 'Néant'}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Quantité du produit</label>
                                        <span class="border-success form-control">{{ $demande->quantite_produit ? $demande->quantite_produit :'Néant'}}</span>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Origine du produit</label>
                                        <span class="border-success form-control">{{ $demande->origine_produit ? $demande->origine_produit : 'Néant'}}</span>                                        
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Destination du produit</label>
                                        <span class="border-success form-control">{{ $demande->destination_produit ? $demande->destination_produit : 'Néant'}}</span>                                        
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Moyen de transport</label>
                                        <span class="border-success form-control">{{ $demande->moyen_transport ? $demande->moyen_transport : 'Néant'}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Immatriculation</label>
                                        <span class="border-success form-control">{{ $demande->immatriculation ? $demande->immatriculation : 'Néant'}}</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Duree du transport</label>
                                        <span class="border-success form-control">{{ $demande->duree_parcours ? $demande->duree_parcours : 'Néant'}}</span>
                                    </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('statusChange', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p005_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="signer{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('uploadActe', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p005_s'] ) }}">
                                                @csrf
                                    ...
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p005_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="assigner{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('assignation', ['model' =>'AffectationP005', 'idDemande' => $demande->uuid ,'nameDemandeId'=> 'demande_p005_id', 'tableName'=>'demande_p005_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="rejetter{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="put" action="{{ route('rejetter', ['id' =>$demande->uuid, 'table' => 'demande_p005_s']) }}">
                                                @csrf
                                                @method('PUT')
