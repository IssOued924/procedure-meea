                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp007-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold"> <strong>Nom & Prénom</strong> </label>
                                        <span class="border-success form-control">{{ $demande->usager->nom.' '.$demande->usager->prenom}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold"> <strong>Numéro</strong> </label>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <span class="border-success form-control">{{ $demande->beneficiaire}}</span>
                                    </div>
                                    <div class="col-6">
                            ...
                            <hr>
                            <div class="row">                                
                                <h5 class="fs-title">Producteur</h5>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <label class="nom_societe fw-bold"> <strong>Pays de production</strong> </label>
                                    <span class="border-success form-control">{{ Helpers::paysNom($demande->pays_producteur)}}</span>
                                </div>
                                <div class="col-6">
                                    <label class="nom_societe fw-bold"> <strong>Nom du producteur</strong> </label>
                                        <span class="border-success form-control">{{ $demande->nom_producteur}}</span>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-6">
                                <label class="siege_social fw-bold">Adresse du producteur</label>
                                            <span class="border-success form-control">{{ $demande->adresse_producteur}}</span>                                        
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Délai de biodégradabilité en nombre de mois</label>
                                        <span class="border-success form-control">{{ $demande->delai}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Micronage</label>
                                        <span class="border-success form-control">{{ $demande->micronage}}</span>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Poids unitaire du produit</label>
                                        <span class="border-success form-control">{{ $demande->poids}}</span>                                        
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Autres Caractéristiques physicochimiques</label>
                                        <span class="border-success form-control">{{ $demande->description_physique}}</span>                                        
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Quantité annuelle de production ou d'importation</label>
                                        <span class="border-success form-control">{{ $demande->quantite_annuel}}</span>
                                    </div>
                                </div>
                                <br>
                                <br>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('statusChange', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p007_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="signer{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('uploadActe', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p007_s'] ) }}">
                                                @csrf
                                    ...
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p007_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="assigner{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('assignation', ['model' =>'AffectationP007', 'idDemande' => $demande->uuid ,'nameDemandeId'=> 'demande_p007_id', 'tableName'=>'demande_p007_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="rejetter{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="put" action="{{ route('rejetter', ['id' =>$demande->uuid, 'table' => 'demande_p007_s']) }}">
                                                @csrf
                                                @method('PUT')
