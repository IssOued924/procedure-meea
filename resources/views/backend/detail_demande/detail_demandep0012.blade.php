                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp0012-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                                    ...
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p0012_s'] ) }}">
                                                @csrf
