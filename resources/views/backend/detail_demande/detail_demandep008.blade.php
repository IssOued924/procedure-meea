...
@section('title')
    ...
    <div class="col-6 offset-3"> @if(session('error'))
                    ...
                    @endif</div>
        <h1>Liste des Demandes d'autorisation de Gestion des dechets Solide</h1>
        <nav>
            <ol class="breadcrumb">
                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp008-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold"> <strong>Dénomination de la société</strong> </label>
                                        <span class="border-success form-control">{{ $demande->beneficiaire}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="siege_social fw-bold">Siège social</label>
                                ...
                                <div class="row">
                                    ...
                                    <label class="siege_social fw-bold">Adresse</label>
                                                <span class="border-success form-control">{{ $demande->adresse_beneficiaire}}</span>                                        
                                    </div>

                                    <div class="col-6">
                                    <label class="siege_social fw-bold">Activités ménées</label>
                                        <span class="border-success form-control">{{ $demande->activite_menes ? $demande->activite_menes : 'Néant'}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('statusChange', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p008_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="signer{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('uploadActe', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p008_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="assigner{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('assignation', ['model' =>'AffectationP008', 'idDemande' => $demande->uuid ,'nameDemandeId'=> 'demande_p008_id', 'tableName'=>'demande_p008_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="rejetter{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="put" action="{{ route('rejetter', ['id' =>$demande->uuid, 'table' => 'demande_p008_s']) }}">
                                                @csrf
                                                @method('PUT')
