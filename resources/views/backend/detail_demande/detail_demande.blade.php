                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        ($demande->etat == 'D' && $demande->last_agent_assign == Auth::user()->agent->uuid && in_array($userRole, ['Etudes', 'Gestionnaire', 'Administration'])) ||
                            ...
                            <div class="modal fade" id="montant{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p001_s'] ) }}">
                                                @csrf
