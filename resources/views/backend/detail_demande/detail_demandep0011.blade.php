                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp0011-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    ...
                                    <label class="siege_social fw-bold">Adresse Postale</label>
                                                <span class="border-success form-control">{{ $demande->adresse_beneficiaire ? $demande->adresse_beneficiaire : 'Néant'}}</span>                                        
                                    </div>
                            ...
                            <hr>
                            <div class="row">                                
                                <h5 class="fs-title">Information sur le site </h5>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <label class="nom_societe fw-bold"> <strong>Statut de la zone</strong> </label>
                                    <span class="border-success form-control">{{ $demande->statut ? $demande->statut : 'Néant'}}</span>
                                </div>
                                <div class="col-6">
                                    <label class="nom_societe fw-bold"> <strong>Espèce Concerné</strong> </label>
                                        <span class="border-success form-control">{{ $demande->espece_coupe ? $demande->espece_coupe : 'Néant'}}</span>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-6">
                                <label class="siege_social fw-bold">Dépot</label>
                                            <span class="border-success form-control">{{ $demande->depot ? $demande->depot : 'Néant'}}</span>                                        
                                </div>
                                <div class="col-6">
                                    <label class="nom_societe fw-bold">Superficie</label>
                                    <span class="border-success form-control">{{ $demande->superficie ? $demande->superficie : 'Néant'}}</span>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-6">
                                    <label class="nom_societe fw-bold">Quota/Quantite</label>
                                    <span class="border-success form-control">{{ $demande->quantite ? $demande->quantite : 'Néant'}}</span>
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('statusChange', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p0011_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="signer{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('uploadActe', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p0011_s'] ) }}">
                                                @csrf
                                    ...
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p0011_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="rejetter{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="put" action="{{ route('rejetter', ['id' =>$demande->uuid, 'table' => 'demande_p0011_s']) }}">
                                                @csrf
                                                @method('PUT')
