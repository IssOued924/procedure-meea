                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp002-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label class="nom_societe fw-bold">Domaine</label>
                                        <span class="border-success form-control">{{ $demande->domaine}}</span>
                                    </div>
                                    <div class="col-3">
                                        <label class="pays_residence fw-bold">Catégorie</label>
                                        <span class="border-success form-control">{{ $demande->categorie}}</span>
                                    </div>
                                    <div class="col-3">
                                        <label class="pays_residence fw-bold">Sous domaine</label>
                                        <span class="border-success form-control">{{ $demande->sous_domaine}}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('assignation', ['model' =>'AffectationP002', 'idDemande' => $demande->uuid ,'nameDemandeId'=> 'demande_p002_id', 'tableName'=>'demande_p002_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="montant{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p002_s'] ) }}">
                                                @csrf
