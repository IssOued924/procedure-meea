                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div style="float: right">
                                        ...
                                        @endphp
                                        <a href="{{ route('demandesp004-list')}}" title="Retour" type="button" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
                                        ...
                                        ($demande->etat == 'S' && in_array($userRole, ['Gestionnaire', 'Administration']))) && ($demande->etat != 'A' ))
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Nom commun</label>
                                        <span class="border-success form-control">{{ $demande->nom_commun}}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Nom scientifique</label>
                                        <span class="border-success form-control">{{ $demande->nom_scientifique}}</span>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Classe d'age</label>
                                        <span class="border-success form-control">{{ $demande->classe_age_animal}}</span>                                        
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Sexe animal</label>
                                        <span class="border-success form-control">{{ $demande->sexe_animal}}</span>                                        
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Lieu de provenance</label>
                                        <span class="border-success form-control">{{Helpers::paysNom($demande->lieu_provenance) }}</span>
                                    </div>
                                    <div class="col-6">
                                        <label class="pays_residence fw-bold">Conditions d'acquisition</label>
                                        <span class="border-success form-control">{{ $demande->condition_acquisition}}</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <label class="nom_societe fw-bold">Motif de la détention</label>
                                        <span class="border-success form-control">{{ $demande->motif_detention}}</span>
                                    </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('statusChange', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p004_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="signer{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data" action="{{ route('uploadActe', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p004_s'] ) }}">
                                                @csrf
                                    ...
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data"
                                                action="{{ route('enregMontant', ['idDemande' => $demande->uuid , 'tableName'=>'demande_p004_s'] ) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="rejetter{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bgcustom-gradient-light">
                                        ...
                                        <div class="modal-body">
                                            <form method="put" action="{{ route('rejetter', ['id' =>$demande->uuid, 'table' => 'demande_p004_s']) }}">
                                                @csrf
                                                @method('PUT')
