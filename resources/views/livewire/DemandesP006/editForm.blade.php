                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success form-control" value="{{ $demande->identite }}"   name="identite"  placeholder="Nom prénom"  /> <br />
                                            </div>

                                            <div class="col-6">
                                                <label class="nom_societe fw-bold"> <strong>Téléphone</strong> <span style="color: red">*</span></label> <br />
                                                <input type="text" class="border-success form-control" value="{{ $demande->beneficiaire }}"    name="beneficiaire"  placeholder="ex : 70700000"  /> <br />
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <select name="commune_id" id="" class="form-select select2 border-success"  style="width: 100%;" required>
