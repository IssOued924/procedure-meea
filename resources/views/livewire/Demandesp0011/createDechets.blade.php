                            ...
                            <form id="msform">
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="nom_societe fw-bold">Denomination de la société<span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="border-success" name="nom_societe"
                                                    placeholder="Denomination de la société" />
                                            </div>
                                            <div class="col-6">
                                                <label class="siege_social fw-bold">Siège social<span style="color:red">
                                                        *</span></label>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class=" fw-bold">Arrete de faisabilité<span
                                                        style="color: red">*</span></label>
