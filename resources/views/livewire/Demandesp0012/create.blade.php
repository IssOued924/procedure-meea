                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <span id="errorCheckbox" style="display:none; color:red">Svp! Choississez un type d'exploitant</span>
                                            </div>
                                        </div><br>
...
$(".next").click(function () {
    if (!testSize()) {
        ...
        //is_touristique is_photographique is_cinematographique
        current_fs.find('input[name=is_touristique]').each(function () {
            //if ($(this).val() === "") {
            if (!$("input[name=is_touristique]").is(":checked") && !$("input[name=is_photographique]").is(":checked") && !$("input[name=is_cinematographique]").is(":checked")) {
                isValid = false;
                $("#errorCheckbox").show();
            } else {
                $("#errorCheckbox").hide();
