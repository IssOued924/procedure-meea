                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <select name="province_id" id="provinces" class="form-select select2 border-success" required >
                                            ...
                                            <div class="col">
                                                ...
                                                <select name="commune_id"  id="communes" class="form-select select2 border-success" required  style="width: 100%;">
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row" style="font-weight: bold">
                                            <input type="checkbox" id="confirmationBox" name="confirmed"
                                                class="required-checkbox   checkbox" {{ intval($demande->confirmed ==1) ? 'checked' : '' }} value="1" required style="margin: 1px 10px;">
