...
return new class extends Migration
{
    ...
    {
        Schema::create('demande_p0010_s', function (Blueprint $table) {
            ...
            $table->string('adresse_origine')->nullable();
            $table->string('lieu_coupe')->nullable();
            $table->string('superficie_lieu_coupe')->nullable();
            $table->string("espece_coupe");
    ...
    {
        Schema::dropIfExists('demande_p0010_s');
    }
};
