...
return new class extends Migration
{
    ...
    {
        Schema::create('demande_p009_s', function (Blueprint $table) {
            ...
            $table->bigInteger('tarif_bois')->default(0);
            $table->bigInteger('tarif_charbon')->default(0);
    ...
    {
        Schema::dropIfExists('demande_p009_s');
    }
};
