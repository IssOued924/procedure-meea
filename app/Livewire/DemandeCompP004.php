...
class DemandeCompP004 extends Component
{
    ...
    public function goToEditDemande($id){
        $this->editDemande = DemandeP004::find($id)->toArray();
    ...
    public function saveDemande() {
        ...
        $this->validate();
            ...
            $demande   = new DemandeP004();
            $demande->nom  =  $this->nom;
            $demande->prenom=$this->prenom;
            $demande->certificat_origine  = $this->certificat_origine;
            $demande->certificat_sanitaire  = $this->certificat_sanitaire;
